    ...
    public class ShilAndPalindromeResearch {
        ...
        private static void solve() {
            ...
            n = fs.nextInt();
            int q = fs.nextInt();
            fw_tree = new int[n + 1][26];
            for (int i = 0; i <= n; i++)
                Arrays.fill(fw_tree[i], 0);
        ...
        private static void add(int i, char c) {
        ...
        private static void substract(int i, char c) {
            while (i <= n) {
                fw_tree[i][c - 'a']--;
                i += lsb(i);
            }
