        ...
        for (int i = 0; i < len; i++) {
            ...
            if (i + 1 < len) {
                if (list.get(i).size() > 1) {
                    if (list.get(i).get(list.get(i).size() - 2) < list.get(i + 1).get(0))
                        ans = Math.max(ans, list.get(i).size() + list.get(i + 1).size() - 1);
                }
                if (list.get(i + 1).size() > 1) {
                    if (list.get(i).get(list.get(i).size() - 1) < list.get(i + 1).get(1))
                        ans = Math.max(ans, list.get(i).size() + list.get(i + 1).size() - 1);
                }
            }
        }
