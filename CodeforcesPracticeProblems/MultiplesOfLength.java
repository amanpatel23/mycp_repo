...
public class MultiplesOfLength {
    ...
    private static void solve() {
        ...
        long n = fs.nextLong();
        Integer[] nums = readIntArray((int) n);
        if (n == 1) {
            fw.out.println(1 + " " + 1);
            fw.out.println(-nums[0]);
            for (int i = 0; i < 2; i++) {
                fw.out.println(1 + " " + 1);
                fw.out.println(0);
            }
        ...
        fw.out.println(1 + " " + 1);
        fw.out.println(((n - 1) * nums[0]) + " ");
        fw.out.println(1 + " " + n);
        for (int i = 0; i < n; i++) fw.out.print((-n * nums[i]) + " ");
        fw.out.println();
        fw.out.println(2 + " " + n);
        for (int i = 1; i < n; i++) fw.out.print(((n - 1) * nums[i]) + " ");
        fw.out.println();
