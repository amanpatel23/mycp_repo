...
public class Remove_One_Element_2 {
    ...
    private static void solve() {
        ...
        for (int i = 0; i < n; i++) {
            if (arr[i] > prev) {
                ...
                util(right, left, i - 1, cnt);
                cnt = 1;
            }
            prev = arr[i];
        }
        util(right, left, n - 1, cnt);
    ...
    private static void util(int[] right, int[] left, int i, int cnt) {

        for (int idx = i, tempCnt = 1; tempCnt <= cnt; idx--, tempCnt++)
            right[idx] = tempCnt;
        for (int idx = i, tempCnt = cnt; tempCnt >= 1; idx--, tempCnt--)
            left[idx] = tempCnt;
    }
