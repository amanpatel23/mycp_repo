...
public class K_LCM_Hard {
    ...
    private static void solve() {
        ...
        int temp = k - 3;
        int n_new = n - temp;
        int[] half_ans = util(n_new);
        for (int i = 0; i < 3; i++) fw.out.print(half_ans[i] + " ");
        for (int i = 0; i < temp; i++) fw.out.print(1 + " ");
        fw.out.println();
    }
    ...
    private static int[] util(int n) {
        if ((n & 1) == 1) {
            int div = n / 2;
            return new int[]{div, div, 1};
        }

        int div = n / 2;
        if ((div & 1) == 1) {
            return new int[]{div - 1, div - 1, 2};
        }
        return new int[]{div, div / 2, div / 2};
    }
