...
public class Palindromic_Numbers {
    ...
    private static void solve() {
        ...
        String str2;
        if (str.charAt(0) == '9')  str2 = "1".repeat(n + 1);
        else str2 = "9".repeat(n);
        String ans = substractString(str2, str);
        fw.out.println(ans);
    }

    private static String substractString(String num1, String num2) {
        ...
        ans.reverse();
        int idx = 0;
        while (idx < n1 && ans.charAt(idx) == '0') idx++;
