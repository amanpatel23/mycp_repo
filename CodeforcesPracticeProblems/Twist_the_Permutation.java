...
public class Twist_the_Permutation {
    ...
    private static void solve() {
        ...
        for (int i = n - 1; i >= 0; i--) {
            ...
            int j = 0;
            for (int ii = idx + 1; ii <= i; ii++) temp_arr[j++] = arr[ii];
            for (int ii = 0; ii <= idx; ii++) temp_arr[j++] = arr[ii];
            for (int ii = i + 1; ii < n; ii++) temp_arr[j++] = arr[ii];
            arr = temp_arr;
            ans[i] = idx + 1;
        }
        for (int xx : ans) fw.out.print(xx + " ");
        fw.out.println();
    }
