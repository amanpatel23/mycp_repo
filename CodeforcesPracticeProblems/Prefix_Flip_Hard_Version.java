...
public class Prefix_Flip_Hard_Version {
    ...
    private static void solve() {
        ...
        fw.out.print(operations.size() + " ");
        for (int x : operations) fw.out.print(x + " ");
        fw.out.println();
    }
