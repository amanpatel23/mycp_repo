...
public class Hello2022 {
    ...
    private static void solve() {
        ...
        int n = fs.nextInt();
        int l = fs.nextInt(), r = fs.nextInt(), c = fs.nextInt();

        int global_min = l, global_max = r;
        int min1 = l, max1 = r, cost = c;
        int min2 = l, max2 = r, cost1 = c, cost2 = c;
        fw.out.println(c);
        ...
        for (int i = 1; i < n; i++) {
            ...
            global_min = Math.min(global_min, l);
            global_max = Math.max(global_max, r);

            // single range
            if ((l < min1 && r > max1) || (l == min1 && r > max1) || (r == max1 && l < min1)) {
                min1 = l;
                max1 = r;
                cost = c;
            } else if (l == min1 && r == max1 && c < cost) {
                cost = c;
            }
            ...
            if (r > max2) {
                max2 = r;
                cost2 = c;
            } else if (r == max2 && c < cost2) {
                cost2 = c;
            }

            long result1 = lMax, result2 = lMax;
            if (min1 == global_min && max1 == global_max) {
                result1 = cost;
            }
            if (min2 == global_min && max2 == global_max) {
                result2 = cost1 + cost2;
            }
